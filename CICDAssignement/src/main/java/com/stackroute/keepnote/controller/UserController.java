...
public class UserController {
	...
	public ResponseEntity<User> registerUser(@RequestBody User user,HttpSession session){
		...
		try {
			tempUser = userService.getUserById(user.getUserId());
	 ...
	 */
	@PutMapping("user/{id}")
	public ResponseEntity<User> updateUser(@RequestBody User user,@PathVariable("id") String id,HttpSession session) {
		...
		User us = null;
		try {
			us = userService.updateUser(user, id);
		} catch (Exception e) {	}
		if(us!=null) {
	...
	public ResponseEntity<User> deleteUser(@PathVariable("id") String id,HttpSession session) {
